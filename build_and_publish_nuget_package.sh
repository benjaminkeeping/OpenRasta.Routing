...
project_src_dir='./src/OpenRasta.Routing'
build_mode='Release'
...
# build project
$msbuild $project_src_dir/OpenRasta.Routing.csproj /property:Configuration=$build_mode > $build_log
...
cp $project_output_dir/OpenRasta.Routing.dll $build_dir/lib/net40

# package
$nuget pack $package_spec_file -OutputDirectory $package_output_dir

# push to gallery (requires api key is set on command line)
$nuget push $package_output_dir/OpenRasta.Routing.$newversion.nupkg
